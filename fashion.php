...
<html>
<head>
<title>Fashion Studies Colleges</title>
<style>
table {
...
<body>
  ...
  <h1 style="color: darkblue; font-family: verdana; text-align:center;">Take a look at some of the <b>Top Fashion Universities</b> from across the globe!</h1>
<table>
<tr>
<th>Id</th>
<th>College Name</th>
...
$sql = "SELECT id, name, link, loc FROM fashion";
